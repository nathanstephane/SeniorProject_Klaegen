<div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="00userStarter.php"><img src="../assets/images/KleagenGrandBon.svg" alt="klaegen Logo" class="img-fluid logo">
            <span>Klaegen</span></a>
...
?></strong></a>
                    <ul class="dropdown-menu dropdown-menu-right account vivify flipInY">
                        <li><a href="00userProfile.php"><i class="icon-user"></i>My Profile</a></li>
                        <li><a href="00encryptedList.php"><i class="icon-envelope-open"></i>Messages</a></li>
