                ...
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Complaint Stats</li>
                            </ol>
                        </nav>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        <div class="header">
                            <h2>A summary of all the complaints you've issued.</h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php 
                                    $query=mysqli_query($con,"select * from complaints where userID='".$_SESSION['id']."'"); 
                                    // if($query){
                                    //     echo "Passed";
                                    // }
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <span>Pending</span> <?php }
                                            if($status=="Processing"){ ?>
                                            <span>Processing</span> <?php }
                                            if($status=="Closed"){ ?>
                                            <span>Closed</span>
                                            <?php } ?></td>
                                        </tr>
