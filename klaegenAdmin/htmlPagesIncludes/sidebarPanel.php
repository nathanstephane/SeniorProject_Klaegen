<div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="adminDashboard.php"><img src="../assets/images/KleagenGrandBon.svg" alt="Klaegen Logo" class="img-fluid logo"><span>Klaegen</span></a>
        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="04createComplaint.php"><i class="icon-diamond"></i><span>Create a complain</span></a></li>
                    <li><a href="../hrms/index.html"><i class="icon-rocket"></i><span>Complaint Stats</span></a></li>
                    ...
                    <li><a href="adminDashboard.php"><i class="icon-info"></i><span>Dashboard</span></a></li>
                    <li class="header">Category Info</li>
                    <li>
                        <a href="#" class="has-arrow"><i class="icon-docs"></i><span>Manage</span></a>
                        <ul>
                            <li><a href="00categoryinfo.php">Category</a></li>
                            <li><a href="00subcategoryinfo.php">Sub-Category </a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                    <li>
                        <a href="#" class="has-arrow"><i class="icon-users"></i><span>users</span></a>
                        <ul>
                            <li><a href="00staff.php">Staff</a></li>
                            <li><a href="00students.php">Student</a></li>
