                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php 
                                    $query=mysqli_query($con,"select complaints.*,users.idNumber as studentID from complaints join users on users.id=complaints.userID where complaints.status is null "); 
                                    if($query){
                                        echo "Passed";
                                    }
