...
if (isset($_POST['submit'])) {
    ...
    if ($row>0) {
        ...
        $redir="00login.php";
        $_SESSION['feedbackLogout']="Incorrect credentials";
        $host=$_SERVER['HTTP_HOST'];
        $url=rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
        header("location:http://$host$url/$redir");
        exit();
        ...
        <div class="card">            
            <div class="body">
                ...
                <form class="form-auth-small" method="POST" >
                    <div class="mb-3">
                        <span style="color: #ff421c;"><?php echo htmlentities($_SESSION['feedbackLogout']); ?><?php echo htmlentities($_SESSION['feedbackLogout']=""); ?></span>
