...
<link rel="icon" href="klagenTileimg.svg" type="image/x-icon">
<!-- VENDOR CSS -->
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php 
                                    $status='Closed';
                                    $query=mysqli_query($con,"select complaints.*,users.idNumber as studentID from complaints join users on users.id=complaints.userID where complaints.status ='$status' "); 
                                    // if($query){
                                    //     echo "Passed";
                                    // }
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-success">Closed/Solved</span></td>
