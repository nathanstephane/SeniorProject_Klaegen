...
<head>
<title>complaint details | Klaegen Admin</title>
<meta charset="utf-8">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        $query=mysqli_query($con,"select complaints.*,users.name as name,users.surname as surname,users.id as usrid,complaintcategory.categoryName as categName from complaints join users on users.id=complaints.userID join complaintcategory on complaintcategory.id=complaints.categoryID where complaints.id='".$_GET['complaintId']."'"); 
                        ...
                        ?>
                                ...
                                <div class="col-md-4" id="sentBy"><a href="#dataModal" id="<?php echo htmlentities($row['usrid']); ?>" class="view_data" name="view" ><?php $fullname = $row['name']." ".$row['surname']; echo htmlentities($fullname); ?></a></div>   
                                
                                <label for="receivedBy" class="col-md-2">Received By:</label>
                                <div class="col-md-4" id="receivedBy"><?php echo htmlentities($row['receiver']); ?></div>
