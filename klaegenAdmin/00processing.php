...
<head>
<title>Processing | Klaegen</title>
<meta charset="utf-8">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        <div class="body">
                            <h4 class="align-center">Complaints being processed</h4>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php 
                                    $state='Processing';
                                    $query=mysqli_query($con,"select complaints.*,users.idNumber as studentID from complaints join users on users.id=complaints.userID where complaints.status ='$state' "); 
                                    // if($query){
                                    //     echo "Passed";
                                    // }
