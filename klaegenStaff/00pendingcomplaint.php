                ...
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Unprocessed</li>
                            </ol>
                        </nav>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        <div class="body">
                            <h4 class="align-center">Unprocessed Complaints</h4>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    $query=mysqli_query($con,"select complaints.*,users.idNumber as studentID,staffusers.id as staffID from complaints join users on users.id=complaints.userID join staffusers on staffusers.id=complaints.receiver where complaints.status is null and receiver ='".$_SESSION['prof']."' ");
                                    
                                    $query2=mysqli_query($con,"select complaints.id,users.idNumber,complaints.title,complaints.date_issued,staffusers.fullName from complaints join users on users.id=complaints.userID join staffusers on staffusers.id=complaints.receiver");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-danger">Not Solved</span></td>
