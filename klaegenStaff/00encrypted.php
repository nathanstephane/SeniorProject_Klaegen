                ...
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Anonymous Messages</li>
                            </ol>
                        </nav>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        <div class="body">
                            <h4 class="align-center">Message Log</h4>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php 
                                    $query=mysqli_query($con,"select * from anonymous_complaint where receiver='".$_SESSION['prof']."'"); 
                                    // if($query){
                                    //     echo "Passed";
                                    // }
