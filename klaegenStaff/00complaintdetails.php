                ...
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Complaint Detail</li>
                            </ol>
                        </nav>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        $query=mysqli_query($con,"select complaints.*,users.name as name,users.surname as surname,users.id as usrid,staffusers.fullName as fully,complaintcategory.categoryName as categName from complaints join users on users.id=complaints.userID join staffusers on staffusers.id=complaints.receiver join complaintcategory on complaintcategory.id=complaints.categoryID where complaints.id='".$_GET['complaintId']."'"); 
                        ...
                        ?>
                                ...
                                <div class="col-md-10" id="state"><?php if(is_null($row['status'])){ echo "Needs to be Processed"; } 
                                else { echo "Updated"; } ?>
                                    </div>
                                ...
                                <div class="col-md-4" id="sentBy"><a href="#dataModal" id="<?php echo htmlentities($row['usrid']); ?>" class="view_data" name="view" ><?php $fullname = $row['name']." ".$row['surname']; echo htmlentities($fullname); ?></a> <hr></div>   
                                
                                <label for="receivedBy" class="col-md-2">Complaint sent To :</label>
                                <div class="col-md-4" id="receivedBy"><?php echo htmlentities($row['fully']); ?> <hr></div>
...
<div class="modal-content">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                ...
                                <label for="status" class="col-md-2"><?php $status1="Processing"; $status2="Closed"; if($row['status']==$status1){echo "Status Updated:";}else if($row['status']==$status2){echo '<span>Updated Status:</span>';}?></label>
                                ...
                                <?php if($row['status']=="Closed"){ } else {?>
                                    <br>
                                    <button type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-primary">Update</button> <?php } ?>
