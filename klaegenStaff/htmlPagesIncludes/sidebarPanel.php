<div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="00staffDashboard.php"><img src="../assets/images/KleagenGrandBon.svg" alt="Oculux Logo" class="img-fluid logo"><span>Klaegen</span></a>
            <button type="button" class="btn-toggle-offcanvas btn btn-sm float-right"><i class="lnr lnr-menu icon-close"></i></button>
        </div>
        <div class="sidebar-scroll">
            <div class="user-account">
            <div class="user_div">
                <?php $nama=$_SESSION['staffLogin']; $getPic=mysqli_query($con,"select image from staffusers where username='$nama'" ); 
                while($retour=mysqli_fetch_array($getPic)){
                ?>
                    <?php $photo=$retour['image']; if($photo==""): ?>
                    <img src="../assets/images/user.png" class="user-photo"  alt="User Profile Picture">
                    <?php else:?>
                        <img src="../klaegenStaff/userimages/<?php echo htmlentities($photo)?>" class="user-photo " alt="User Profile Picture" width="40" height="40" style="object-fit: cover;">
                    <?php endif;?>
                </div>
                <?php }?>
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong><?php echo htmlentities($_SESSION['staffLogin']);?></strong></a>
                    <ul class="dropdown-menu dropdown-menu-right account vivify flipInY">
                        <li><a href="00staffProfile.php"><i class="icon-user"></i>My Profile</a></li>
                        <li><a href="00encrypted.php"><i class="icon-envelope-open"></i>Messages</a></li>
                        <!-- <li><a href="javascript:void(0);"><i class="icon-settings"></i>Settings</a></li> -->
                        <li class="divider"></li>
                        <li><a href="00staffLogout.php"><i class="icon-power"></i>Logout</a></li>
                    </ul>
                </div>                
            </div>  
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="00staffDashboard.php"><i class="icon-speedometer"></i><span>Dashboard</span></a></li>
                    <li><a href="00staffProfile.php"><i class="icon-user"></i><span>View Profile</span></a></li>
                    <li><a href="00encrypted.php"><i class="icon-key"></i><span>Anonymous</span></a></li>
                    <!-- <li><a href="../jobportal/index.html"><i class="icon-badge"></i><span>User info</span></a></li> -->
                    <li><a href="#"><i class="icon-cursor"></i><span>Klaegen Forum</span></a></li>
